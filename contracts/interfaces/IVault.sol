...
interface IVault {
    ...
    @param amountToDeposit The amount of ether sent in the transaction
    */
    ...
    */
    ...
    @param repaymentAmount the address of the vault owner
    ...
    */
    ...
    /**
    @notice Returns an estimate on how much stablecoin could be minted at the current rate
